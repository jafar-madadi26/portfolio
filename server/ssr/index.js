...
var client_references_default = {
	"15c18cfaeeff": async () => {
		const m = await import("./assets/layout-segment-context-DR-09Yd6.js");
		return { get "LayoutSegmentProvider"() {
			return m["LayoutSegmentProvider"];
		} };
	},
	"593f344dc510": async () => {
		const m = await import("./assets/error-boundary-Ba5ymgEo.js");
		return {
			get "ErrorBoundary"() {
	...
	"597c19416243": async () => {
		const m = await import("./assets/theme-provider-1PDl99tq.js");
		return { get "ThemeProvider"() {
	...
	"9fb86276be8f": async () => {
		const m = await import("./assets/image-Wj40A6c9.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"c2747888630f": async () => {
		const m = await import("./assets/link-BRb1KcpW.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"cf7e29e4902d": async () => {
		const m = await import("./assets/header-vYuczQ6E.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"f2a0dd86b59e": async () => {
		const m = await import("./assets/contact-cta-CiuZOFFi.js");
		return { get "default"() {
			return m["default"];
		} };
	}
