...
function getDraftSecret() {
	return "a21697fb-c44e-425f-a13e-8620e3874291";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "a628cba4-16fa-47c8-aceb-e15ffe238cb7";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "a628cba4-16fa-47c8-aceb-e15ffe238cb7") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "a628cba4-16fa-47c8-aceb-e15ffe238cb7",
		rootBoundaryId
	});
}
/**
